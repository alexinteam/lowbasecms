...
<div class="container-2 page-content">
    <div class="">
        <div class="w-main left">
            ...
            <div class="block-news-archive block-rewiew-2">
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-news">
                            ...
                            <div class="cell-news cell-text-news">
                                ...
                                <h3 class="name-news"><a href="javascript:">Отличная кухня и хороший персонал</a></h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-news">
                            <div class="cell-news">
                                <div class="thumbnail-middle thumbnail-news"><a href="#"><img src="images/bg-5.png" alt=""></a></div>
                            </div>
                            <div class="cell-news cell-text-news">
                                <p class="date-news">18.11.2016</p>
                                <h3 class="name-news"><a href="javascript:">Все прекрасно - приду еще!</a></h3>
                                <p class="text-news">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                            </div>
                            <a href="javascript:" class="abs-item close-news">&times;</a>
                            <a href="javascript:" class="abs-item edit-news"></a>
